...
public class OrderStation : ISelectable {
	...
	static Order[] orders = {
		new Order { type = eOrderType.ORDER, resource = eResource.MEAT, cost = 10 },
		new Order { type = eOrderType.ORDER, resource = eResource.VEGETABLES, cost = 10 },
	};
	...
	public void Reset()
	{
		orderedResources[eResource.MEAT] = 0;
		orderedResources[eResource.VEGETABLES] = 0;
	}
}
